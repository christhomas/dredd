...
If you have any issues integrating the test suite to your project, reach out to the maintainers in `Dredd issues <https://github.com/antimatter-studios/dredd/issues>`__, we're happy to help!
...
-  `File an issue <https://github.com/antimatter-studios/dredd/issues/new>`__ and get help from Dredd maintainers.
