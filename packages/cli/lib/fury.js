...
const apiBlueprintParser = require('@antimatter-studios/apib-parser');
const apiBlueprintSerializer = require('@antimatter-studios/apib-serializer');
const apiaryBlueprintParser = require('@antimatter-studios/apiaryb-parser');
const oas2Parser = require('@antimatter-studios/openapi2-parser');
const oas3Parser = require('@antimatter-studios/openapi3-parser');
const pkg = require('../package.json');

const adapters = [
  '@antimatter-studios/apib-parser',
  '@antimatter-studios/apib-serializer',
  '@antimatter-studios/apiaryb-parser',
  '@antimatter-studios/openapi2-parser',
  '@antimatter-studios/openapi3-parser',
];
...
function getVersion() {
  const packages = ['@antimatter-studios/cli'].concat(adapters);
