...
[![NPM version](https://img.shields.io/npm/v/@antimatter-studios/core.svg)](https://www.npmjs.org/package/@antimatter-studios/core)
[![License](https://img.shields.io/npm/l/@antimatter-studios/core.svg)](https://www.npmjs.org/package/@antimatter-studios/core)
...
```sh
$ npm install --save @antimatter-studios/core
```
