...
const [fsStub, fsForwarded] = stubbable(realFs);
...
const MarkdownReporter = (
  await esmock('../../../build/reporters/MarkdownReporter.js', {
    '../../../build/logger.js': loggerStub,
    '../../../build/reporters/reporterOutputLogger.js':
