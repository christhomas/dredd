// The package's own declarations. These described an ambient module named "gavel" while the
// package was published under that name; inside the monorepo TypeScript resolves this file
// directly, so the declarations are the module rather than being wrapped in one.
