...
- 136aa60: Stop reporting enforced JSON Schema keywords as unsupported.
...
The package has been updated for compatibility with `@antimatter-studios/core`.
...
The package has been renamed to `@antimatter-studios/openapi3-parser`.
