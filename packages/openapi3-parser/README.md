...
```shell
$ npm install @antimatter-studios/openapi3-parser
```

```js
const { Fury } = require('fury');
const openapi3Adapter = require('@antimatter-studios/openapi3-parser');
...
[contributing
document](https://github.com/antimatter-studios/dredd/blob/master/packages/openapi3-parser/CONTRIBUTING.md).
...
[status document]: https://github.com/antimatter-studios/dredd/tree/master/packages/openapi3-parser/STATUS.md
[1.0.0 Milestone]: https://github.com/antimatter-studios/dredd/milestone/1
[good first issue]: https://github.com/antimatter-studios/dredd/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3Aopenapi3+label%3A%22good+first+issue%22
